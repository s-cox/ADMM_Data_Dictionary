...
| Construct           | [Expected Service Life][Departure - DAS ID](https://s-cox.github.io/ADMM_data_dictionary/docs/attribute/expectedservicelife.html)                           | The time period during which the asset is expected to remain suitable for its intended use.                                                                                                       |
...
| Inventory           | [Manufacturer][Location Text](https://s-cox.github.io/ADMM_data_dictionary/docs/attribute/manufacturer.html)                                     | The manufacturer of the asset.                                                                                                                                                                    |
| Inventory           | [Owner][Location Text](https://s-cox.github.io/ADMM_data_dictionary/docs/attribute/owner.html)                                            |                                                                                                                                                                                                   |
...
| Inventory           | [Product Name/ID][Location Text](https://s-cox.github.io/ADMM_data_dictionary/docs/attribute/productnameid.html)                                  |                                                                                                                                                                                                   |
| Inventory           | [Section][Location Text](https://s-cox.github.io/ADMM_data_dictionary/docs/attribute/section.html)                                          | Section referencing is used to divide the network into sections. Further information can be found in section 4 of the Part 2 - Requirements and Additional Information document.                  |
...
| Inventory           | [XSP][X Start (Easting)](https://s-cox.github.io/ADMM_data_dictionary/docs/attribute/xsp.html)                                             | Defines the location of the asset across the carriageway.                                                                                                                                         |
